...
import { repositoryCallArgs, ormConfigContent } from "./ormDriver";

export const OFFICIAL_PRESETS = ["auth", "orm", "realtime", "i18n"] as const;
...
`,
  ...
  log(`Added "${preset}" to features/${preset}/`);

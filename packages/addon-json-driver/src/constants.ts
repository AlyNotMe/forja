...
export const OVERFLOW_HEADER_SIZE = 8;
export const OVERFLOW_OFFSET_NEXT_PAGE = 0;
export const OVERFLOW_OFFSET_VALID_BYTES = 4;
export const MAX_OVERFLOW_PAYLOAD_BYTES = DEFAULT_PAGE_SIZE - OVERFLOW_HEADER_SIZE;
